...
export default function Home() {
  ...
  return (
    <>
      <NavigationBar />
      <div className="flex flex-col min-h-screen bg-white font-sans text-base-content">

        {/* Hero Section */}
        <main className="flex-1 flex flex-col items-center justify-center p-6 md:p-16">
          <div className="card max-w-2xl bg-gray-200 shadow-lg rounded-3xl mt-16">
            <div className="card-body items-center text-center p-8 md:p-12">

              {/* Project Welcome Icon */}
              <div className="bg-black/5 p-4 rounded-full text-black mb-2">
              ...
              <p className="max-w-md text-sm text-black/50 mb-8">
              ...
              {!session && (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                  ...
                  {/* Sign In Option */}
                  <div className="flex flex-col justify-between items-center p-6 rounded-3xl bg-base-50 hover:shadow-md transition">
                    ...
                    <Link
                      href="/sign-in"
                      className="btn bg-yellow-400 btn-block rounded-full gap-2 border-0 shadow-none"
                    >
                  ...
                  <div className="flex flex-col justify-between items-center p-6 rounded-3xl bg-base-50 hover:shadow-md transition">
                    ...
                    <Link
                      href="/sign-up"
                      className="btn btn-ghost btn-block border-0 bg-red-800 rounded-full shadow-none gap-2"
                    >
